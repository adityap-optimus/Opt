...
import com.filemanager.server.views.ViewFactory;
import com.filemanager.utils.CommonUtil;

/**
 * This is class handles the request of showing the list of files
 * @author Anubhav
 *
 */
public class HttpFBHandler implements HttpRequestHandler {
    ...
    private HttpEntity respView(HttpRequest request, File dir) throws IOException {
        ...
        data.put("dirpath", dir.getPath()); 
        data.put("hasParent", !isSamePath(dir.getPath(), this.webRoot)); 
        data.put("fileRows", buildFileRows(dir)); 
